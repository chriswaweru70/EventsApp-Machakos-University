  ...
  <v-dialog persistent v-model="registerDialog">
    ...
    <v-card>
      <v-container>
        ...
        <v-layout row wrap>
          <v-flex xs12>
            <v-card-text v-if="userIsRegistered">You can always change your decision later on.</v-card-text>
            <v-card-text v-else>Yeeeeeei we are happy you joined.</v-card-text>
          </v-flex>
        </v-layout>
        <v-layout row wrap>
          <v-flex xs12>
